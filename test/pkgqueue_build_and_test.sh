...
assert_true pkgqueue_add test pkg
assert_true pkgqueue_add_dep test pkg "build" pkg
...
assert_true pkgqueue_prioritize test bash 48
...
assert_true pkgqueue_get_next job_type pkgname
assert "pkg" "${pkgname}"
assert "test" "${job_type}"
assert_true pkgqueue_clean_queue test "${pkgname}" "${clean_rdepends-}"
assert_true pkgqueue_job_done test "${pkgname}"
